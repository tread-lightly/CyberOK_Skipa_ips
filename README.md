...
Добавлены ```89.169.28.210``` (p-access-01.cyberok.ru) и ```89.169.28.191```
(mongo3.cyberok.ru). Достаточно [подозрительная подсеть](https://www.abuseipdb.com/check-block/89.169.28.0/24)

UPD 18.03.2025:

Добавлен ```89.169.28.214``` (p-access-02.cyberok.ru)

UPD 26.03.2026 (Да, список всё ещё поддерживается):

Добавлена подсеть ```62.76.98.0/24```, спасибо @ALCUler

UPD 25.05.2026

Убран 85.142.100.2 (В списке уже есть вся подсеть 85.142.100.0/24)
